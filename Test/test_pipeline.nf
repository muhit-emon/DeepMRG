...
params.IND_fasta = "${projectDir}/STM6070_HMR_genes_IND.fasta" // STM 6070 HMR genes used as independent set in the paper
...
workflow {
	...
	else if ( params.test_set == "IND" ){
		input_ch = Channel.from(params.IND_fasta) // this channel contains input seq fasta file
		params.test_seq = params.IND_fasta
	}
