...
params.fold1_fasta = "${projectDir}/Fold1.fasta" // Dataset under 5-fold cross-validation (Fold 1)
params.fold2_fasta = "${projectDir}/Fold2.fasta" // Dataset under 5-fold cross-validation (Fold 2)
params.fold3_fasta = "${projectDir}/Fold3.fasta" // Dataset under 5-fold cross-validation (Fold 3)
params.fold4_fasta = "${projectDir}/Fold4.fasta" // Dataset under 5-fold cross-validation (Fold 4)
params.fold5_fasta = "${projectDir}/Fold5.fasta" // Dataset under 5-fold cross-validation (Fold 5)

params.test_set = "TEST" // TEST has been used as default. It will be overridden when given as --test_set
//params.test_seq = "${projectDir}/TEST.fasta"
