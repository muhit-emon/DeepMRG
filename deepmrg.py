...
if __name__ == "__main__":
    ...
    DeepMRG_model1 = str(sys.argv[4])
    DeepMRG_model2 = str(sys.argv[5])
    DeepMRG_model3 = str(sys.argv[6])
    DeepMRG_model4 = str(sys.argv[7])
    DeepMRG_model5 = str(sys.argv[8])
    output_prefix = str(sys.argv[9])
    ...
    compute_bitscore_feature_mat_with_clusters_of_ref_exp_and_annotation(testing_bitscore_distribution, testing_seq, ref_exp_mrg_cluster_wise, DeepMRG_model1, DeepMRG_model2, DeepMRG_model3, DeepMRG_model4, DeepMRG_model5, output_prefix)
