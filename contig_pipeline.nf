...
process run_deepmrg {
	...
	"""
	python3 ${projectDir}/deepmrg.py $prot_seq $bitscore_distribution ${params.path_of_bacmet_exp_db_clusters_json} ${params.path_of_deepmrg_model} ${params.out_prefix}
	"""
